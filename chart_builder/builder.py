...
class Builder(object):
    ...
    def add_deployment(self, service_name, deployment):
        ...
        generator = ResourceTemplate(**self._services[service_name])
        generator.gen_deployment(deployment)

        self._services[service_name]["deployments"].append(generator.get_template())
        self._services[service_name]["values"] = generator.update_values(self._services[service_name]["values"])
    ...
    def add_configmap(self, configmap):
        ...
        self._values = generator.update_values(self._values)
